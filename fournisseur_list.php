...
<div id="layoutSidenav_content">
     <main>
        <div class="container-fluid px-4">
             <h2 class="mt-4">fournisseurs</h2>   
                <div class="card mb-4">
                   <div class="card-header d-flex justify-content-between">
                      <h4 class="card-title">Gestion des fournisseurs</h4>
                      <a href="fournisseur_add.php" class="btn btn-primary btn-round ml-auto"><i class="fa fa-plus"></i>Ajouter un fournisseur</a>            
                    </div>
                    ...
                    <table id="datatablesSimple" class="datatable-table">
                      ...
                      <tbody>
                         <?php foreach($fournisseurs as $fournisseur) {?>
                               <tr>
                                  <td><?php echo $fournisseur['fournisseur_nom'] ?></td>
                                  <td><?php echo $fournisseur['fournisseur_prenom'] ?></td>
                                  <td><?php echo $fournisseur['fournisseur_telephone'] ?></td>
                                  <td><?php echo $fournisseur['fournisseur_adresse'] ?></td>
                                  <td><?php echo $fournisseur['fournisseur_email'] ?></td>
                                  <td>
                                     <div class="form-button-action">                                    
                                         <a href="fournisseur_update.php?id=<?php echo $fournisseur['fournisseur_id'] ?>" class="btn btn-link btn-success btn-lg"><i class="fa fa-edit"></i></a>
                                         <a href="fournisseur_delete.php?id=<?php echo $fournisseur['fournisseur_id'] ?>" class="btn btn-link btn-danger"><i class="fa fa-times"></i> </a>                           
                                      </div>
                                 </td>
                              </tr>
                        <?php } ?>     
